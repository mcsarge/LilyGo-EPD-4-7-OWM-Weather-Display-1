...
Button2::Button2(byte attachTo, String buttonName, byte buttonMode /*= INPUT_PULLUP*/, unsigned int debounceTimeout /*= DEBOUNCE_MS*/)
{
    pin = attachTo;
...
void Button2::setButtonName(String buttonName)
{
